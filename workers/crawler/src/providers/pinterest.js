// Portado de src/providers/pinterest/pinterest.provider.js (api-croche-search).
// Lógica idêntica - já era fetch+JSON puro, 100% portável pro runtime do
// Workers. Única mudança: recebe baseUrl/timeoutMs como parâmetros em vez
// de importar o env.js do Node (que usa dotenv/zod, específico do processo
// Node local).
